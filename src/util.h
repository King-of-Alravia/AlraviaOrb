...
#ifndef ALRAVIAORB_UTIL_H
#define ALRAVIAORB_UTIL_H
...
static const int64 ORB = 100000000;
static const int64 FRAGMENT = 1000000;
...
{
    std::string s = strprintf("alraviaorb-%s", name);
