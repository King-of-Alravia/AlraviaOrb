...
WalletFrame::WalletFrame(AlraviaOrbGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
    clientModel(0)
{
    ...
    walletStack->setAlraviaOrbGUI(gui);
...
void WalletFrame::gotoReceiveOrbsPage()
{
    walletStack->gotoReceiveOrbsPage();
}

void WalletFrame::gotoSendOrbsPage(QString addr)
{
    walletStack->gotoSendOrbsPage(addr);
}
