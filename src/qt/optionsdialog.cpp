    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new AlraviaOrbUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->AlraviaOrbAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Orb Cave."), QMessageBox::Ok);
